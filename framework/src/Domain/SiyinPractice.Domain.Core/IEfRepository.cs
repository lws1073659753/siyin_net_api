...
namespace SiyinPractice.Domain.Core
{
       ...
       where TEntity : IEntity
    {
        ...
        Task<TEntity?> FindAsync(Guid keyValue, IEnumerable<Expression<Func<TEntity, object>>> navigationPropertyPath = null, bool writeDb = false, bool noTracking = true, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken"><see cref="CancellationToken"/></param>
        /// <returns></returns>
        Task<TEntity?> FindAsync(Expression<Func<TEntity, bool>> whereExpression, IEnumerable<Expression<Func<TEntity, object>>> navigationPropertyPath = null, Expression<Func<TEntity, object>>? orderByExpression = null, bool ascending = false, bool writeDb = false, bool noTracking = true, CancellationToken cancellationToken = default);
       ...
       // List<T> Query<T>(Expression<Func<T, bool>> predicate) where T : class;
        Task<bool> BulkUpdateAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default);
        //Task<int> BulkInsertAsyncByTable(DataTable dataTable, CancellationToken cancellationToken = default);
