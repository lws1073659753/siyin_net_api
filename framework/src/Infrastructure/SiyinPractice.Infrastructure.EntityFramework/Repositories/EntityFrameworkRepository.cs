...
{
    public class EntityFrameworkRepository<TEntity> : AbstractBaseRepository<DbContext, TEntity>, IEfRepository<TEntity>
      where TEntity : Entity, new()
    {
        private readonly IAdoQuerierRepository? _adoQuerier;

        public EntityFrameworkRepository(DbContext dbContext, IAdoQuerierRepository? adoQuerier = null)
            : base(dbContext)
        ...
        public virtual async Task<TEntity?> FindAsync(Guid keyValue,
        ...
        public virtual async Task<TResult?> FetchAsync<TResult>(Expression<Func<TEntity, TResult>> selector,
