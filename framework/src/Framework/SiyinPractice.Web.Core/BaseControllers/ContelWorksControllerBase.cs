...
{
    public abstract class ContelWorksControllerBase : ControllerBase
    {
        /// <summary>
        ...
        //[NonAction]
        //protected virtual ObjectResult Problem(SiyinPractice.Shared.Core.Dto.ProblemDetails problemDetails)
        //{
