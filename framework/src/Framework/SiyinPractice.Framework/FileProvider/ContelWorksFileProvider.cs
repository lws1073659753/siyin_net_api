...
namespace SiyinPractice.Framework.FileProvider
{
    /// <summary>
    /// IO functions using the on-disk file system
    /// </summary>
    public class ContelWorksFileProvider : PhysicalFileProvider, IContelWorksFileProvider
    {
        public ContelWorksFileProvider(string webRootPath, string contentRootPath)
         : base(File.Exists(webRootPath) ? Path.GetDirectoryName(webRootPath) : contentRootPath)
        {
