...
namespace SiyinPractice.Framework.Security
{
    ...
    /// HashHelper
    /// </summary>
    public static partial class HashGeneraterExtension
    {
        /// <summary>
        /// 获取哈希之后的字符串
        /// </summary>
        ...
        public static string GetHashedString(this IHashGenerater _, HashType type, string plaintext, bool isLower) => _.GetHashedString(type, plaintext, Encoding.UTF8, isLower);
        ...
        /// <param name="isLower">是否是小写</param>
        /// <returns>哈希算法处理之后的字符串</returns>
        public static string GetHashedString(this IHashGenerater _, HashType type, string plaintext, Encoding encoding, bool isLower = false) => _.GetHashedString(type, plaintext, null, encoding, isLower);
        ...
        public static string GetHashedString(this IHashGenerater _, HashType type, string plaintext, string key, Encoding encoding, bool isLower = false)
        {
            ...
            return _.GetHashedString(type, plaintextByte, keyByte, isLower);
        }
        ...
        public static string GetHashedString(this IHashGenerater _, HashType type, byte[] source) => _.GetHashedString(type, source, null);
        ...
        /// <returns>hash过的字节数组</returns>
        public static string GetHashedString(this IHashGenerater _, HashType type, byte[] source, bool isLower) => _.GetHashedString(type, source, null, isLower);
        ...
        public static string GetHashedString(this IHashGenerater _, HashType type, byte[] source, byte[] key, bool isLower = false)
        {
            ...
            var hashedBytes = _.GetHashedBytes(type, source, key);
        ...
        /// <returns>hash过的字节数组</returns>
        public static byte[] GetHashedBytes(this IHashGenerater _, HashType type, string plaintext) => _.GetHashedBytes(type, plaintext, Encoding.UTF8);
        ...
        public static byte[] GetHashedBytes(this IHashGenerater _, HashType type, string plaintext, Encoding encoding)
        {
            ...
            return _.GetHashedBytes(type, bytes);
        }
        ...
        /// <returns></returns>
        public static byte[] GetHashedBytes(this IHashGenerater _, HashType type, byte[] bytes) => _.GetHashedBytes(type, bytes, null);
