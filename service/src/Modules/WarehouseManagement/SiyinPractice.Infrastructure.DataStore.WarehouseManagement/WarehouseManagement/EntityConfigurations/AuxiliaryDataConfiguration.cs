...
{
    public class AuxiliaryDataConfiguration : AbstractEntityTypeConfiguration<Auxiliary>
    {
        public override void Configure(EntityTypeBuilder<Auxiliary> builder)
        {
            base.Configure(builder);
            builder.ToTable("wm_auxiliary_data");
