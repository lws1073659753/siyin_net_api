namespace SiyinPractice.Domain.Shared.AccessControl
{
    public class CachingConsts : SiyinPractice.Domain.Shared.CachingConsts
    {
        //cache key
        ...
        //public const string DeptGetAll = "adnc:usr:depts:allList";
